...
public class CommentsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        comment_list.setAdapter(commentsRecyclerAdapter);
                ...
                firebaseFirestore.collection("Educations/" + blog_post_id + "/Comments")
        ...
        comment_post_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!comment_message.isEmpty()){
                    ...
                    firebaseFirestore.collection("Educations/" + blog_post_id + "/Comments").add(commentsMap).addOnCompleteListener(new OnCompleteListener<DocumentReference>() {
                        @Override
